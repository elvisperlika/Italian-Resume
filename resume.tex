...
\geometry{left=1.4cm, top=.5cm, right=1.4cm, bottom=0.8cm, footskip=.5cm}
...
\definecolor{russell}{HTML}{1a659e}
...
% \photo[rectangle,edge,right]{./profilo}
\name{Elvis}{Perlika}
% \position{Software Engineer{\enskip\cdotp\enskip}Computer Scientist}
% \address{Forlì, Italia}

\mobile{+39 375 526 4175}
\email{elvisperlika29@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/elvisperlika}
\linkedin{linkedin.com/elvisperlika}
% \gitlab{gitlab-id}
